...
import { MATERIALS, DESIGN_PRINCIPLES } from '../constants';
import { BrandingCard } from './BrandingCard';
import { BrandingItem } from '../types';
import { X } from 'lucide-react';

export const BrandingGrid: React.FC = () => {
  const items: BrandingItem[] = [...MATERIALS, ...DESIGN_PRINCIPLES];
  const [selectedItem, setSelectedItem] = useState<BrandingItem | null>(null);
      ...
      <section className="my-16">
        <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-text-main mb-4">
                <span className="text-accent-bronze block md:inline mr-0 md:mr-3">VISUAL & SENSORY</span>
                <span className="block md:inline">FOUNDATIONS</span>
            </h2>
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-text-muted font-light leading-relaxed">
              The physical embodiment of the doctrine. Textures, tones, and principles that define the Dark Elegance aesthetic.
            </p>
        </div>
